...
// LessThanOrEqualTo checks if a version is less than or equal to enother
func (v Version) LessThanOrEqualTo(other Version) bool {
	return v.compareTo(other) <= 0
}

// GreaterThan checks if a vesion is greater than another
func (v Version) GreaterThan(other Version) bool {
	return v.compareTo(other) == 1
}

// GreaterThanOrEqualTo checkf if a version is greater than or equal to another
